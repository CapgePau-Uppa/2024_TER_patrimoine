...
public class MerimeeData {
    ...
    public String toString() {
        return "MerimeeData [titre_editorial_de_la_notice=" + titre_editorial_de_la_notice + ", reference=" + reference
                ...
                + statut_juridique_de_l_edifice + ", historique=" + historique + ", lien_vers_la_base_archiv_mh="
                + lien_vers_la_base_archiv_mh + ", region=" + region + ", commune_forme_index=" + commune_forme_index
